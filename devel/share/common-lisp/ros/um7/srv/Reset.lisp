...
(cl:defmethod cl:initialize-instance :after ((m <Reset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name um7-srv:<Reset-request> is deprecated: use um7-srv:Reset-request instead.")))

(cl:ensure-generic-function 'zero_gyros-val :lambda-list '(m))
(cl:defmethod zero_gyros-val ((m <Reset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader um7-srv:zero_gyros-val is deprecated.  Use um7-srv:zero_gyros instead.")
  (zero_gyros m))

(cl:ensure-generic-function 'reset_ekf-val :lambda-list '(m))
(cl:defmethod reset_ekf-val ((m <Reset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader um7-srv:reset_ekf-val is deprecated.  Use um7-srv:reset_ekf instead.")
  (reset_ekf m))

(cl:ensure-generic-function 'set_mag_ref-val :lambda-list '(m))
(cl:defmethod set_mag_ref-val ((m <Reset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader um7-srv:set_mag_ref-val is deprecated.  Use um7-srv:set_mag_ref instead.")
  (set_mag_ref m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Reset-request>)))
  ...
  "626ea3efbc6874926126840202a803dd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Reset-request)))
  "Returns md5sum for a message object of type 'Reset-request"
  "626ea3efbc6874926126840202a803dd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Reset-request>)))
  ...
  (cl:format cl:nil "bool zero_gyros~%bool reset_ekf~%bool set_mag_ref~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Reset-request)))
  "Returns full string definition for message of type 'Reset-request"
  (cl:format cl:nil "bool zero_gyros~%bool reset_ekf~%bool set_mag_ref~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Reset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name um7-srv:<Reset-response> is deprecated: use um7-srv:Reset-response instead.")))
