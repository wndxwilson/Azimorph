...
(cl:defclass <HectorDebugInfo> (roslisp-msg-protocol:ros-message)
  ((iterData
    :reader iterData
    :initarg :iterData
    :type (cl:vector hector_mapping_nav-msg:HectorIterData)
   :initform (cl:make-array 0 :element-type 'hector_mapping_nav-msg:HectorIterData :initial-element (cl:make-instance 'hector_mapping_nav-msg:HectorIterData))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <HectorDebugInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HectorDebugInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_mapping_nav-msg:<HectorDebugInfo> is deprecated: use hector_mapping_nav-msg:HectorDebugInfo instead.")))

(cl:ensure-generic-function 'iterData-val :lambda-list '(m))
(cl:defmethod iterData-val ((m <HectorDebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_mapping_nav-msg:iterData-val is deprecated.  Use hector_mapping_nav-msg:iterData instead.")
  (iterData m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HectorDebugInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'iterData)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hector_mapping_nav-msg:HectorIterData))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HectorDebugInfo>)))
  ...
  "hector_mapping_nav/HectorDebugInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HectorDebugInfo)))
  "Returns string type for a message object of type 'HectorDebugInfo"
  "hector_mapping_nav/HectorDebugInfo")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HectorDebugInfo>)))
  ...
  (cl:format cl:nil "HectorIterData[] iterData~%================================================================================~%MSG: hector_mapping_nav/HectorIterData~%float64[9] hessian~%float64 conditionNum~%float64 determinant~%float64 conditionNum2d~%float64 determinant2d~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HectorDebugInfo)))
  "Returns full string definition for message of type 'HectorDebugInfo"
  (cl:format cl:nil "HectorIterData[] iterData~%================================================================================~%MSG: hector_mapping_nav/HectorIterData~%float64[9] hessian~%float64 conditionNum~%float64 determinant~%float64 conditionNum2d~%float64 determinant2d~%~%~%"))
