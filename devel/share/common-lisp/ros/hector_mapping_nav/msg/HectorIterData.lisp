...
(cl:defmethod cl:initialize-instance :after ((m <HectorIterData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HectorIterData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hector_mapping_nav-msg:<HectorIterData> is deprecated: use hector_mapping_nav-msg:HectorIterData instead.")))

(cl:ensure-generic-function 'hessian-val :lambda-list '(m))
(cl:defmethod hessian-val ((m <HectorIterData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_mapping_nav-msg:hessian-val is deprecated.  Use hector_mapping_nav-msg:hessian instead.")
  (hessian m))

(cl:ensure-generic-function 'conditionNum-val :lambda-list '(m))
(cl:defmethod conditionNum-val ((m <HectorIterData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_mapping_nav-msg:conditionNum-val is deprecated.  Use hector_mapping_nav-msg:conditionNum instead.")
  (conditionNum m))

(cl:ensure-generic-function 'determinant-val :lambda-list '(m))
(cl:defmethod determinant-val ((m <HectorIterData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_mapping_nav-msg:determinant-val is deprecated.  Use hector_mapping_nav-msg:determinant instead.")
  (determinant m))

(cl:ensure-generic-function 'conditionNum2d-val :lambda-list '(m))
(cl:defmethod conditionNum2d-val ((m <HectorIterData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_mapping_nav-msg:conditionNum2d-val is deprecated.  Use hector_mapping_nav-msg:conditionNum2d instead.")
  (conditionNum2d m))

(cl:ensure-generic-function 'determinant2d-val :lambda-list '(m))
(cl:defmethod determinant2d-val ((m <HectorIterData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_mapping_nav-msg:determinant2d-val is deprecated.  Use hector_mapping_nav-msg:determinant2d instead.")
  (determinant2d m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HectorIterData>)))
  ...
  "hector_mapping_nav/HectorIterData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HectorIterData)))
  "Returns string type for a message object of type 'HectorIterData"
  "hector_mapping_nav/HectorIterData")
