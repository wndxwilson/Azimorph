...
if("TRUE" STREQUAL "TRUE")
  set(hackaton_SOURCE_PREFIX /home/dinesdkumar/catkin_ws/src/hackaton)
  set(hackaton_DEVEL_PREFIX /home/dinesdkumar/catkin_ws/devel)
  set(hackaton_INSTALL_PREFIX "")
  set(hackaton_PREFIX ${hackaton_DEVEL_PREFIX})
else()
  set(hackaton_SOURCE_PREFIX "")
  set(hackaton_DEVEL_PREFIX "")
  set(hackaton_INSTALL_PREFIX /home/dinesdkumar/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dinesdkumar <dinesdkumar@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hackaton' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dinesdkumar/catkin_ws/src/hackaton/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hackaton_NUM_DUMMY_TARGETS)
      set(hackaton_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hackaton::wrapped-linker-option${hackaton_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hackaton_NUM_DUMMY_TARGETS "${hackaton_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hackaton::wrapped-linker-option${hackaton_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hackaton_LIBRARIES "${interface_target_name}")
